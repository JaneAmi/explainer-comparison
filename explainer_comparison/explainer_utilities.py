...
def evaluate_quality_of_explanations(factory: ExplainerFactory, X_data, explainers=None) -> pd.DataFrame:
    results = []
    available_explainers = ["lime", "ebm", "mimic"]  # Easily extendable for additional explainers
